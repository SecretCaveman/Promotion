...
N_meas = 10;
t= 5/4 *pi + 1/2* pi*[0:N_meas-1]/N_meas;
p.N_ieq = 128;
p.sobo_Index = 0;
...
p.true_curve = 'curve_letter_m';
p.noiselevel = 0.050;
p.N_FK = 100;
p.init_guess = init_letter_m(p.N_FK);
...
reg.method = 'BERGNM';%'BERGNM';IRGNM_CG
